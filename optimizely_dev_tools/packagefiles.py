...
def create_config_file(package_name, default_config):
  ...
  file_content = ''
  if default_config:
    resource_path = os.path.join('integration_package_files', 'config_yaml_default_template')
    ...
    resource_path = os.path.join('integration_package_files', 'config_yaml_unconfigured_template')
    file_content = pkg_resources.resource_string(resource_package, resource_path)
...
def create_integration_file(package_name, default_config):
  ...
  file_content = ''
  if default_config:
    resource_path = os.path.join('integration_package_files', 'integration_yaml_default_template')
    file_content = pkg_resources.resource_string(resource_package, resource_path)
    file_content = file_content.format(package_name=package_name)
  else:
    resource_path = os.path.join('integration_package_files', 'integration_yaml_unconfigured_template')
    file_content = pkg_resources.resource_string(resource_package, resource_path)
    file_content = file_content.format(package_name=package_name)
  with open(os.path.join(package_name, file_name), 'w') as f:
    f.write(file_content)
...
def create_example_response_file(package_name, default_config):
  ...
  if default_config:
    resource_path = os.path.join('integration_package_files', 'example.json')
...
def create_functions_js_file(package_name, default_config):
  ...
  if default_config:
    resource_path = os.path.join('integration_package_files', 'functions_default.js')
    template_path = pkg_resources.resource_filename(resource_package, resource_path)
    copyfile(template_path, file_path)
  else:
    resource_path = os.path.join('integration_package_files', 'functions_unconfigured.js')
    template_path = pkg_resources.resource_filename(resource_package, resource_path)
    copyfile(template_path, file_path)
...
def create_functions_js_test_file(package_name, default_config):
  ...
  resource_path = os.path.join('integration_package_files', 'functions_test_default.unittests.js')
  template_path = pkg_resources.resource_filename(resource_package, resource_path)
  copyfile(template_path, file_path)
...
def create_functions_py_file(package_name, default_config):
  ...
  if default_config:
    resource_path = os.path.join('integration_package_files', 'functions_default.py')
    template_path = pkg_resources.resource_filename(resource_package, resource_path)
    copyfile(template_path, file_path)
  else:
    resource_path = os.path.join('integration_package_files', 'functions_unconfigured.py')
    template_path = pkg_resources.resource_filename(resource_package, resource_path)
    copyfile(template_path, file_path)
...
def create_functions_py_test_file(package_name, default_config):
  ...
  resource_path = os.path.join('integration_package_files', 'functions_test_default.py')
  template_path = pkg_resources.resource_filename(resource_package, resource_path)
  copyfile(template_path, file_path)
